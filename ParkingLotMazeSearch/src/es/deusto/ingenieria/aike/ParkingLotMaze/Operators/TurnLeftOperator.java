...
public class TurnLeftOperator extends Operator {
	...
	protected boolean isApplicable(State state) {
		...
		if ( carPositionType.equals(Data.TypeCell.CROSS) ){
			...
			{
				if ( ( flag.getEntrance().equals(Data.Direction.NORTH) &&  car.getDirection().equals(Data.Direction.WEST)) ||
					 ( flag.getEntrance().equals(Data.Direction.SOUTH) &&  car.getDirection().equals(Data.Direction.EAST)) ||
					 ( flag.getEntrance().equals(Data.Direction.WEST) &&  car.getDirection().equals(Data.Direction.SOUTH)) ||
					 ( flag.getEntrance().equals(Data.Direction.EAST) &&  car.getDirection().equals(Data.Direction.NORTH))
					)
					return true;
				else return false;
			}
