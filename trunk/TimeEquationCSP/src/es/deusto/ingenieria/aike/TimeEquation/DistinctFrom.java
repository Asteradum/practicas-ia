...
public class DistinctFrom extends Constraint<Integer> {

	 int value;
	
	public DistinctFrom(List<Variable<Integer>> variables, String name){
		super(name, variables);
	}

	public boolean isSatisfied(Variable<Integer> variable, Integer value) {
		
		if ( ( variable!= null )&& ( this.getVariables().contains(variable) ) && ( this.value != value ) )
			return true;
		else return false;
